...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand page-scroll" href="#page-top">SC Data</a>
        </div>
...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            <h1>SC Data</h1>
            <hr>
            <p>A handy free tool to work with sc knowledge base and operations of various kinds</p>
            <a href="#about" class="btn btn-primary btn-xl page-scroll">Find Out More</a>
            <a href="relationviewer" class="btn btn-primary btn-xl page-scroll">Start</a>
        </div>
    </div>
</header>
...
<section class="bg-primary" id="about">
    <div class="container">
        ...
        <br>
        <img  src="resources/img/ui.jpg" style="border-radius: 30px;">
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <h3>Study easier</h3>
                    <p class="text-muted">Our solutions make your study easier and it should bring you a favor.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <p class="text-muted">You can use this solution whenever you need! From your phone or pc</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <p class="text-muted">We update our product to keep things fresh and make smart product.</p>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 text-center">
                <div class="service-box">
                    ...
                    <p class="text-muted">We really put a lot of effort so that you liked it</p>
                </div>
            </div>
        </div>
    </div>
